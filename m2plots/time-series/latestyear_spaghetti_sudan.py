...
####INPUT parameters####
variablename='T2MMAX'
varlongname='Maximum 2 m Temperature'
units='K'
collection='statM_2d_slv_Nx'
lat1=3
lat2=22
lon1=22
lon2=38
...
####LOAD DATA####
DS = xr.open_mfdataset('/discover/nobackup/projects/gmao/merra2/data/products/MERRA2_400/Y*/M*/MERRA2_400.' + collection + '.*.nc4')
...
fig, ax = plt.subplots()
line1=ax.plot(np.arange(1,endmonth+1,1),weighted_mean.sel(time=slice(str(endyear) + "-01-01", str(endyear) + "-" + str(endmonth+1) + "-01")),'r',label=str(endyear))
