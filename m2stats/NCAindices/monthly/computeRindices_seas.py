...
#Compute ETCCDI
	r95=prectot-prec95p
	print('r95: ', r95.shape, prec95p.shape, prectot.shape, type(prectot))
	r95[r95<0]=np.nan
	r95[r95>=0]=1
...
for n in range(3):
	for d in range(mnthlength[m[n]-1]):
		...
		print('flxfile is: ', '/discover/nobackup/projects/gmao/merra2/data/products/MERRA2_400' + '/Y' + str(y[n]) + '/M' + str(m[n]).zfill(2) + '/MERRA2_400.tavg1_2d_flx_Nx.' + str(y[n]) + str(m[n]).zfill(2) + str(d+1).zfill(2) + '.nc4')
