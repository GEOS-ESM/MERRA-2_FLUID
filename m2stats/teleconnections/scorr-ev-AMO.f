      parameter (nx=90,ny=70,mode=4,ntel=4,nt=1419)
      dimension evref(nx,ny),evref1(ntel,nx,ny),ev(nx,ny),pc(mode)

      open (11,file='evAMO-ANN19612021ref.d',form='unformatted',
     & access='direct',recl=nx*ny,status='old')
      open (12,file='pc-AMO-DJF18702021.d',form='unformatted',
     & access='direct',recl=mode,status='old')
      open (13,file='ev-AMO-DJF18702021.d',form='unformatted',
     & access='direct',recl=nx*ny,status='old')

      open (14,file='pc-AMO-DJF18702021rv.d',form='unformatted',
     & access='direct',recl=1,status='unknown')
      open (15,file='ev-AMO-DJF18702021rv.d',form='unformatted',
